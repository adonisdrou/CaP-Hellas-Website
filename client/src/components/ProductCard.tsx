    ...
    <Card className="overflow-hidden group border-2 border-accent/20 shadow-lg transition-all duration-500 hover:shadow-2xl hover:border-accent/60 hover:scale-105 h-full glassmorphism">
      ...
      <CardContent className="p-4 bg-gradient-to-br from-card/40 to-card/20 backdrop-blur-sm">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3 className="font-semibold text-lg group-hover:text-primary transition-colors duration-300" data-testid={`text-product-name`}>
            {name}
          </h3>
        ...
        <p className="text-sm text-muted-foreground group-hover:text-foreground/70 transition-colors duration-300" data-testid={`text-product-category`}>
          {category}
        </p>
      </CardContent>
    </Card>

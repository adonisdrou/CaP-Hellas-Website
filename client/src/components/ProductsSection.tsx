...
const allProducts: Product[] = [
  ...
  { nameKey: 'lettuce', image: lettuceImage, origin: 'greece', category: 'vegetables' },
  { nameKey: 'carrots', image: carrotsImage, origin: 'greece', category: 'vegetables' },
  { nameKey: 'broccoli', image: broccoliImage, origin: 'greece', category: 'vegetables' },
  { nameKey: 'cabbage', image: cabbageImage, origin: 'greece', category: 'vegetables' },
  { nameKey: 'potatoes', image: potatoesImage, origin: 'greece', category: 'vegetables' },
